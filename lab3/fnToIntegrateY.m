function [val] = fnToIntegrateY(x1, y1, z1, phi, z)
%Integrand Value [val] = fnToIntegrateY(x1, y1, z1, phi, z)
%Written By: Csaba Nemeth
%
%fnToIntegrateY takes five vector arguments:
...
%y-componenet By of the magnetic field. 
...
%cross R in the y direction.
val = ((u_0 .* R)./(4.*pi.*mag_r.^3)).*(-k_x.*r_z + k_z.*r_x);
