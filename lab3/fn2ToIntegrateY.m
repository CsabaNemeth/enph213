function [val] = fn2ToIntegrateY(phi, z)
%Integrand Value [val] = fn2ToIntegrateY(phi, z)
%Written By: Csaba Nemeth
%
%fn2ToIntegrateY takes two vector arguments:
% phi -> Angular position along magnet.
% z -> height along magnet.
%
%The function returns an integrand in the y direction that can be used to integrate the force
