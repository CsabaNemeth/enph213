function [] = test_integrateTrapRule()
%[] = test_integrateTrapRule()
% Written by: David DeVries
% loads up a test hysteresis data set and then is integrated using the
% Trapezoid Rule
...
% actual
integralAct = integrateTrapRule(vX, vY);
